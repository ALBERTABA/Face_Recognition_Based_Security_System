...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        self.root.title("Face Recognition-Based Surveillance System")
...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Face Recognition-Based Surveillance System",font=("verdana",20,"bold"),bg="white",fg="navyblue")
