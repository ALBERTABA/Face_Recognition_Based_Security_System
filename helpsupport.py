...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Admin\Desktop\Face_Recognition_Based_Security_System\Images_GUI\bg4.png")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Support",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Admin\Desktop\Face_Recognition_Based_Security_System\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"C:\Users\Admin\Desktop\Face_Recognition_Based_Security_System\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\Admin\Desktop\Face_Recognition_Based_Security_System\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\Admin\Desktop\Face_Recognition_Based_Security_System\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://www.facebook.com/profile.php?id=61573492229680"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/lykamae.palahang"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/@lykamaepalahang"
        webbrowser.open(self.url,new=self.new)
